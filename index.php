...
<body>
    ...
    <div class="tab-container">
        ...
        <div class="tabs">
            <div class="tab active-tab" onclick="showTab(1, this)">Tab 1</div>
            <div class="tab" onclick="showTab(2, this)">Tab 2</div>
            <div class="tab" onclick="showTab(3, this)">Tab 3</div>
        </div>
    </div>
    <footer>
        <div class="menu">
            <a class="menu-item active-menu-item" href="#" onclick="changeColor(this)">
                <i class="fa fa-home"></i>
                Menu
            </a>
            <a class="menu-item" href="#" onclick="changeColor(this)">
